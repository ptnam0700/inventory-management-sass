...
<div className="container">
  <div className="grid lg:grid-cols-3 gap-12 items-start">
    ...
    <div className="flex items-center space-x-4">
      <img
        src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/logo.jpg-RY1B3HOKv0YYE5j8NSMJvrIx3oo4rF.jpeg"
        alt="HATESCO Logo"
        className="h-20 w-20 object-contain"
      />
      <div>
        <h3 className="font-bold text-2xl text-primary">HATESCO</h3>
    ...
    <div className="space-y-4">
      ...
      <div className="pt-6">
        <div className="flex items-center space-x-3">
          ...
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/banner.jpg-peDbKBLUrUL4ajoZv3C4EG2jBexEcq.jpeg"
            alt="YANMAR"
            className="h-8"
          />
        </div>
